...
var (
	...
	// TestCondition3 is the crypto-condition for preimage "zzz".
	// Fulfillment: "zzz" (0x7A, 0x7A, 0x7A)
	// This is cb3 from rippled's escrow tests.
	TestCondition3 = []byte{
		0xA0, 0x25, 0x80, 0x20,
		0x5B, 0x9D, 0xC9, 0x99, 0xEC, 0x5F, 0x95, 0x98,
		0x8B, 0x6A, 0x23, 0xA0, 0x28, 0x2F, 0xC5, 0x8E,
		0x5D, 0x79, 0xA7, 0x34, 0x2E, 0x50, 0x33, 0x9A,
		0x38, 0xB0, 0x10, 0xB1, 0x8D, 0x7A, 0x6E, 0xFB,
		0x81, 0x01, 0x03,
	}

	// TestFulfillment3 is the fulfillment for TestCondition3 (preimage "zzz").
	// This is fb3 from rippled's escrow tests.
	TestFulfillment3 = []byte{
		0xA0, 0x05, 0x80, 0x03, 0x7A, 0x7A, 0x7A,
	}
