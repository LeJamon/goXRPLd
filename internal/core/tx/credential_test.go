...
func TestCredentialCreateValidation(t *testing.T) {
	tests := []struct {
		...
		// Valid cases
		{
			...
			tx: &CredentialCreate{
				BaseTx:         *NewBaseTx(TypeCredentialCreate, "rIssuer"),
				Subject:        "rSubject",
...
func TestCredentialAcceptValidation(t *testing.T) {
	tests := []struct {
		...
		// Valid cases
		{
			...
			tx: &CredentialAccept{
				BaseTx:         *NewBaseTx(TypeCredentialAccept, "rSubject"),
				Issuer:         "rIssuer",
				CredentialType: credMakeHex(5),
			},
			wantErr: false,
...
func TestCredentialDeleteValidation(t *testing.T) {
	tests := []struct {
		...
		// Valid cases
		{
			...
			tx: &CredentialDelete{
				BaseTx:         *NewBaseTx(TypeCredentialDelete, "rAccount"),
				Subject:        "rSubject",
				CredentialType: credMakeHex(5),
			},
			wantErr: false,
...
func TestCredentialTransactionTypes(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			tx:       &CredentialCreate{BaseTx: *NewBaseTx(TypeCredentialCreate, "rTest")},
			expected: TypeCredentialCreate,
		},
		{
			name:     "CredentialAccept type",
			tx:       &CredentialAccept{BaseTx: *NewBaseTx(TypeCredentialAccept, "rTest")},
			expected: TypeCredentialAccept,
		},
		{
			name:     "CredentialDelete type",
			tx:       &CredentialDelete{BaseTx: *NewBaseTx(TypeCredentialDelete, "rTest")},
			expected: TypeCredentialDelete,
		},
	}
...
func TestCredentialConstructors(t *testing.T) {
	t.Run("NewCredentialCreate", func(t *testing.T) {
		...
		assert.Equal(t, TypeCredentialCreate, tx.TxType())
	})
	...
	t.Run("NewCredentialAccept", func(t *testing.T) {
		...
		assert.Equal(t, "6162636465", tx.CredentialType)
		assert.Equal(t, TypeCredentialAccept, tx.TxType())
	})
	...
	t.Run("NewCredentialDelete", func(t *testing.T) {
		...
		assert.Equal(t, "6162636465", tx.CredentialType)
		assert.Equal(t, TypeCredentialDelete, tx.TxType())
	})
}
