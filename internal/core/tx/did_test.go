...
func TestDIDSetValidation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			did: &DIDSet{
				BaseTx: *NewBaseTx(TypeDIDSet, "rN7n3473SaZBCG4dFL83w7a1RXtXtbM2shY"),
		...
		},
		{
			...
			did: &DIDSet{
				BaseTx: BaseTx{Common: Common{TransactionType: "DIDSet"}},
...
func TestDIDDeleteValidation(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			did: &DIDDelete{
				BaseTx: *NewBaseTx(TypeDIDDelete, "rN7n3473SaZBCG4dFL83w7a1RXtXtbM2shY"),
			},
			expectError: false,
		},
		{
			name: "invalid - missing account",
			did: &DIDDelete{
				BaseTx: BaseTx{Common: Common{TransactionType: "DIDDelete"}},
			},
			expectError: true,
		},
	}
...
func TestDIDTransactionTypes(t *testing.T) {
	t.Run("DIDSet type", func(t *testing.T) {
		...
		if d.TxType() != TypeDIDSet {
			t.Errorf("expected TypeDIDSet, got %v", d.TxType())
		}
	})

	t.Run("DIDDelete type", func(t *testing.T) {
		d := NewDIDDelete("rN7n3473SaZBCG4dFL83w7a1RXtXtbM2shY")
		if d.TxType() != TypeDIDDelete {
			t.Errorf("expected TypeDIDDelete, got %v", d.TxType())
		}
	})
}
...
func TestDIDRequiredAmendments(t *testing.T) {
	t.Run("DIDSet requires DID amendment", func(t *testing.T) {
		...
		if len(amendments) != 1 || amendments[0] != AmendmentDID {
			t.Errorf("expected [%s], got %v", AmendmentDID, amendments)
		}
	})
...
func TestDIDEntryHelpers(t *testing.T) {
	...
	t.Run("DIDEntry round-trip serialization", func(t *testing.T) {
		accountID, _ := decodeAccountID("rN7n3473SaZBCG4dFL83w7a1RXtXtbM2shY")
...
func TestTecEMPTY_DID(t *testing.T) {
	if TecEMPTY_DID != 169 {
		t.Errorf("expected TecEMPTY_DID=169, got %d", TecEMPTY_DID)
	}

	str := TecEMPTY_DID.String()
	if str != "tecEMPTY_DID" {
...
func TestTemEMPTY_DID(t *testing.T) {
	if TemEMPTY_DID != -254 {
		t.Errorf("expected TemEMPTY_DID=-254, got %d", TemEMPTY_DID)
	}
}
