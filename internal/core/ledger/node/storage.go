...
// NewNodeStore creates a new NodeStore with the given database path
...
// Store saves a Node to the database
...
// Fetch retrieves a Node from the database
...
// Exists checks if a Node exists in the database
